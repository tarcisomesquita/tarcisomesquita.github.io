...
* http://www.rodsbooks.com/efi-programming/hello.html Best source so far: allowed me to compile the hello world!
...
http://stackoverflow.com/questions/7130726/writing-a-hello-world-kernel

GAS based, no multiboot used.
* https://github.com/littleosbook/littleosbook

* https://github.com/scanlime/metalkit
A more automated / general bare metal compilation system. Untested, but looks promising.
