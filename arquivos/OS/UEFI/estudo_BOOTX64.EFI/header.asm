...
NumberOfSections:            .word 0x0009         # 0x0046 número de seções contidas no aplicativo (entradas em SECTION_HEADER)
...
Characteristics:             .word 0x2226         # 0x0056 indica se o arquivo é um EXE, DLL ou OCX.
...
SizeOfInitializedData:       .long 0x00001C00     # 0x0060 
SizeOfUninitializedData:     .long 0x00000200     # 0x0064 
