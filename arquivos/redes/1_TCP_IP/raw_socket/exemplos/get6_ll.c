...
// TCP checksum (16 bits)
  tcphdr.th_sum = tcp6_checksum (iphdr, tcphdr, (unsigned char *) payload, payloadlen);
...
// TCP header
  memcpy (ether_frame + 14 + IP6_HDRLEN, &tcphdr, TCP_HDRLEN);

// TCP data
  memcpy (ether_frame + 14 + IP6_HDRLEN + TCP_HDRLEN, payload, payloadlen);
