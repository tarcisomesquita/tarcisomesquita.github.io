...
<html>\n\
  ...
  <body bgcolor=\"#99cc99\">\n\
   ...
   <pre>\n", file, file );
      ...
      else for ( i = 0; i < n; ++i ) file_details( file, dl[i]->d_name );
      (void) printf( "\
   </pre>\n\
   <hr>\n\
...
static void file_details( char* dir, char* name ) {
   ...
   if ( lstat( path, &sb ) < 0 ) (void) printf( "<a href=\"%s\">%-32.32s</a>    ???\n", encoded_name, name );
   else {
...
static char *get_mime_type( char* name ) {
   ...
   if ( strcmp( dot, ".xhtml" ) == 0 || strcmp( dot, ".xht" ) == 0 ) return "application/xhtml+xml; charset=UTF-8";
   if ( strcmp( dot, ".jpg" ) == 0   || strcmp( dot, ".jpeg" ) == 0 ) return "image/jpeg";
   if ( strcmp( dot, ".gif" ) == 0 ) return "image/gif";
   if ( strcmp( dot, ".png" ) == 0 ) return "image/png";
   if ( strcmp( dot, ".css" ) == 0 ) return "text/css";
   if ( strcmp( dot, ".xml" ) == 0 || strcmp( dot, ".xsl" ) == 0 ) return "text/xml; charset=UTF-8";
