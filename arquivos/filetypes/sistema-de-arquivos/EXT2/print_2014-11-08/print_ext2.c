...
//   if (print_super_block((unsigned long int)0)) return 1;
//   if (print_group_desc(0, 0)) return 1;
   if (print_inode((unsigned int)0x3001)) return 1;
   if (print_dir_entry((unsigned int)0x204)) return 1;
