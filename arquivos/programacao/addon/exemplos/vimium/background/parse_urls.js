...
Object.defineProperty(t,"__esModule",{value:!0}),t.Ri=t.ru=t.Er=t.Pi=t.Ti=t.qi=t.Se=void 0,t.Se=e=>{
let u,n,f=e.u,s=f.toLowerCase(),a=null,o=!1;if(!i.sn.test(r.pi(s)))return i.Bl(),null;if(e.p){let l=t.qi(e);return{k:"",
s:0,u:l.p!=null?l.u:f,e:l.p!=null?l.p:l.u}}for(u of((n=i.Ur(s))&&(s=s.slice(n),f=f.slice(n)),
l.Gl.rules))if(s.startsWith(u.Ui)&&(a=f.slice(u.Ui.length).match(u.Ai),a))break;if(!a||!u){let e=l.Q.ni
;return s.startsWith(e)?(f=f.slice(e.length).replace(/^#!?/,""),{k:"vimium://show",u:f,
s:f.startsWith("image")&&f.lastIndexOf("&",f.indexOf(":")+1)+1||f.indexOf(" ")+1}):(i.Bl(),null)}
...
;let t=s.indexOf(":");if(t=t>0&&t<s.length?t:0,t&&!i.sn.test(s)&&!s.startsWith("file:")){let e=r.ci(s,t,s.indexOf(" "))
;t=e!==-1&&e<=3?t:0}if(g=t>0?s.startsWith("data:")?2:1:0,g)a=[a[0]];else{let t=typeof p=="object",l=t?p[0]:p
;if(t&&l==="+"){let t=u.Ui.length;u.Ai.global||(t+=a.index),t=n+t+Math.max(0,f.slice(t).indexOf(a[0])),l=r.di(e.u,t),
l=l==="%20"?/%20| /:"+"}a=a[0].split(l)}}else a=a[0].split(p);s="";for(let e of a)s+=" "+(g?e:i.Ye(e))
;s=s.trim().replace(g>1?/\xa0/g:i.F," ")
;let c=l.Gl.map.get("~"),m=!!s&&c.Rl===l.Gl.map.get(u.Dr).Rl&&!l.Gl.map.has(s.split(" ",1)[0]);return i.Bl(),{k:u.Dr,
c:m,u:s,s:o?s.lastIndexOf(" ")+1:0}},t.qi=e=>{let{u:t}=e,n=t.toLowerCase();if(e.p===1){let i=l.R(t,131072,e.s)
;if(i!==t&&i&&i!==t+"/"&&i+"/"!==t){let e=r._r(i,null,-2);if(r.dr===0)return{u:e,p:"(sed)"}}}
if(!i.sn.test(r.pi(n)))return{u:"This url has no upper paths",p:null}
;let f,s,a,o,p=encodeURIComponent,g="",c=!1,m=!1,$=!1,d=null,h=0,_=0,b=!1
;if((a=t.lastIndexOf("#")+1)&&(g=t.slice(a+ +(t.substr(a,1)==="!")),f=i.Ye(g),a=f.lastIndexOf("/"),
...
_=g.indexOf("&",a)+1)),a>=0?h=a:(o=e.exec(g))?(d=i.Ye(o[2]),h=o.index+o[1].length,
_=h+o[2].length):(f=s[1])!=="&"&&(a=t.length-g.length,g=f+p(d),t=t.slice(0,a)+g,h=f.length,
_=0)):h=s.index+s[1].length:h=0,d&&(a=t.length-g.length,h+=a,_>0&&(_+=a))}if(!d){if(n.startsWith(l.Q.H)&&!e.f)return{
...
!$||d&&d!=="/"?(f=b?p(d):d,t=t.slice(0,h)+(_?f+t.slice(_):f)):t=t.split("#",1)[0];let k=l.R(t,64,e.s)||t;if(k!==t){
let e=r._r(k,null,-2);t=r.dr===0?e:t}return{u:t,p:d}};let u=(e,t)=>{var l
;let r=(l=i.Pn(e))===null||l===void 0?void 0:l.host;if(!r)return
...
;t.Ti=(e,l)=>typeof l=="string"&&l.toLowerCase().startsWith("whole")?t.Er(e):n(e),t.Pi=e=>{
...
;let n=l.indexOf("\uff1a")+1
;if(u=l.indexOf(":")+1,u=u&&n?Math.min(u,n):u||n,!u||!i.sn.test(l.slice(0,u-1)+"://"))return e
...
l&&",.;\u3002\uff0c\uff1b".includes(l[0])&&(l=l.slice(1).trim()),o&1&&l&&a.test(l[0])&&(l=l.slice(1)),r.wi(),
...
;if(d=d.replace(/\\s/g," ").trim().replace(/([^\\]|^)%(s)/gi,"$1$$$2").replace(/\\%/g,"%"),o={Dr:"",Rl:d,r:h,Bi:l.size>1
},u.includes("~")&&o.Bi&&(r._r(d,null,-2),r.dr>2&&(u=u.filter(e=>e!=="~"))),u=u.filter($),u.length!==0){if(p===-1){
...
"$"):(p=p>0?p:p+t+1,e)),(n=f(d,p,a))&&(a.includes("$")?(a=a.replace(r.xi,e=>e==="$$"?"\\$":"(.*)"),
s=new RegExp("^"+a,/[a-z]/i.test(a)?"i":"")):s=s||a.trim()||" ",c.push({Ui:n.Ui,Ai:n.Ai,Dr:u[0].trimRight(),Hi:s})))
...
p=e.search(m);let r=i.pl(d,l?p>=0?e.slice(0,p):e:"");r&&(a=t.Ri(a),c.push({Ui:a,Ai:r,Dr:u[0].trimRight(),
Hi:[o.Rl.lastIndexOf("$S")>=0?" ":"+"]})),e=p>=0?e.slice(p+1):""}else e=e.slice(p+4);e=e.trimLeft(),
o.Dr=e?i.Ye(e):u[u.length-1].trimLeft()}}return c};let f=(e,l,r)=>{if(l<1||!i.sn.test(e))return null;let u,n,f,s
...
;return f=f&&i.cl(f).replace(/\\\+|%20| /g,"(?:\\+|%20| )"),u=t.Ri(u),{Ui:u,Ai:new RegExp(n+f+e,/[a-z]/i.test(f)?"i":"")
}};t.Ri=e=>{let t=e.slice(0,9).toLowerCase(),l=i.Ur(t)
;return l?e=e.slice(l):t==="vimium://"&&(e=r.kn(e.slice(9),!1,-1)),e}});