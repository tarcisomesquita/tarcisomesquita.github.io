...
;let a=Math.abs,d=["expect","keys","options","mask"],v=0,p=e=>{let l=n.W(),t=[],r=""
...
;if(f===void 0&&(f=e.host=e.url!=null?e.url:null,delete e.url),v!=null&&t.fe===2!=!!v)return 1
;if(typeof f=="string"&&(f=e.host=o.Fl(f)),f!=null){let e,n=u.url
;if(n==null&&(f.t===3?["/*","*"].includes(f.v.p.pathname)&&f.v.p.search==="*"&&f.v.p.hash==="*":f.t===2&&((e=f.v.indexOf("/",f.v.indexOf("://")+3))===f.v.length-1||e===-1))){
let e=i.j(),l=e&&e.T||t.$;n=l?l.s.Rl:null}if(n==null&&(n=i.I(null,!0))instanceof Promise)return n.then(e=>{var n
;u.url=e||(t.$?(((n=i.j())===null||n===void 0?void 0:n.T)||t.$).s.Rl:""),l.runKeyWithCond(u)}),0;if(!o.Il(f,n))return 1}
if(s!=null){if(!t.$&&s!==!1)return 1;if(typeof s=="string"&&(s=e.iframe=o.Fl(s)||!0),typeof s=="boolean"){
if(s!==!(!t.$||!t.$.s.J))return 1}else if(!o.Il(s,t.$.s.Rl))return 1}if(a==null);else{
if(u.fullscreen==null)return r.getCurWnd(!1,e=>(u.fullscreen=!!e&&e.state.includes("fullscreen"),l.runKeyWithCond(u),
r.oe())),0;if(!!a!==u.fullscreen)return 1}if(d&&d!=="*"){let l=typeof d=="string"?[]:d
...
;if(l.length){if(r==null)return t.$&&i.safePost(t.$,{N:13,n:performance.now(),c:u}),t.$?0:1
...
options:t.length>1?l.parseEmbeddedOptions(t.slice(1)):null}};l.runKeyWithCond=e=>{let n,r=a(t.g),o=i.j()
;t.$||(t.$=o?o.a:null),e=e||t.ki||{},t.ki=null;let u=y(t.M);for(let l of u){if(!l)continue;let t=l.env,r=t
;if(typeof r=="string"){if(!f.io)return void i.showHUD("No environments have been declared");if(r=f.io.get(r),
r===void 0)return void i.showHUD(`No environment named "${t}"`);if(typeof r=="string"&&(r=f.no(r,2),f.io.set(t,r)),
r===null)continue}let o=c(r,e);if(o===0)return;if(o===2){n=l;break}}
let g,m,h=n&&n.keys.length?n.keys:t.M.keys,j=n?typeof n.env=="string"?`[${n.env}]: `:`(${u.indexOf(n)})`:""
;if(h.length===0)i.showHUD(j+"Require keys: comma-seperated-string | string[]");else if(r>h.length&&h.length!==1)i.showHUD(j+"Has no such a key");else if(g=h[m=h.length===1?0:t.g>0?r-1:h.length-r],
g&&(typeof g=="string"||typeof g=="object"&&g.tree&&typeof g.tree=="object"&&typeof g.tree.t=="number")){
let r=h.length===1?t.g:1;if(typeof g=="string"){let e=t.M.mask;if(e!=null){let l=s.fillOptionWithMask(g,e,"",d,r)
...
;let a=n&&n.options&&typeof n.options=="object"&&n.options||t.M.options||(t.M.$masked?null:p(t.M))
;a=s.concatOptions(a,u);let c=(v+1)%64||1,y={keys:o,repeat:r,options:a,cursor:o,timeout:0,id:"single",
fallback:s.parseFallbackOptions(t.M)};if(o.val.length>1||o.val[0].t!==0){let n="<v-runKey:$1>".replace("$1",""+c),r={
$seq:y,$then:n,$else:"-"+n,$retry:-999};y.id=n,v=c,s.replaceCmdOptions(r),t.qn.set(n,f.ii("runKey",r)),
...
return e.length===1&&i.val.push({t:0,val:e,par:i}),n.Bl(),i};let g=(e,l)=>{let t,n,r=!0,i=e;for(i.t===0&&(t=i.par,
n=t.val.indexOf(i),
...
;p&&("<v-runKey:$1>".replace("$1",""+v)===e.id&&(v=Math.max(--v,0)),t.qn.delete(y),clearTimeout(e.timeout||0),b(e,f))
;let $=t.M;if(!f){if(c&&s.runNextCmdBy(l>0?1:0,c,1))return
;let e=l>0?0:((r=$.$f)===null||r===void 0?void 0:r.t)||((o=c===null||c===void 0?void 0:c.$f)===null||o===void 0?void 0:o.t)||0
;return void(e&&i.showHUD(u.Fe(`${e}`)))}
...
;(j||A)&&(e.cursor===e.keys&&(s.overrideCmdOptions({}),$=t.M),$.$then=(j&1?"$l+":"")+(A&1?"$D+":"")+$.$then,
$.$else=(j&2?"$l+":"")+(A&2?"$D+":"")+$.$else);let z=p?0:e.timeout=setTimeout(()=>{let e=t.qn.get(y),l=e&&e.lo
;l&&l.$seq&&l.$seq.timeout===z&&t.qn.delete(y)},3e4);k(f,e,n)},l.parseKeyNode=e=>{let t=e.val
...
;return l?l+(t?"="+r(n.Ye(t.slice(1))):""):""}).join(" "),t){let l=t.split("=",1)[0],n=t.slice(l.length)
;e=l?(e?e+" ":"")+l+(n?"="+r(n.slice(1)):""):e}return f.no(e,2)};let k=(e,r,i)=>{
let o=l.parseKeyNode(e),u=r.cursor===r.keys,f=u||o.prefix.includes("$c"),a=o.prefix.includes("$W"),d=t.M,v=a?s.concatOptions(o.options,n.Vn({
...
},m=e=>!e.includes("<")&&!e.includes(":",1),h=e=>m(e)&&t.qn.get(`<v-${e}>`)||null;t.O=(e,l,n,r)=>{
...
;for(;u=e.indexOf("#",u)+1;){let l=e.slice(0,u-1);if(t.qn.has(l)||h(l)||/^[a-z]+(\.[a-z]+)?$/i.test(l))break}t.$=l,
t.Ce=0,t.M=null,A(u?e.slice(0,u-1):e,o,u?e.slice(u):null,null,n)};let j=e=>{let l=t.M;for(;l&&l!==e;)l=l.$o;return l===e
},A=(e,r,o,u,a,d)=>{let v=e,p=t.qn.get(e)||m(e)&&t.qn.get(v=`<v-${e}>`)||null,c=!0;if(p==null&&e in f.eo&&(c=!1,
p=f.ii(e,null)),p==null){let l=/^\w+$/.test(e)?v:e
;return void i.showHUD(`"${l.length>=20?l.slice(0,19)+"\u2026":l}" has not been mapped`)}if(p.Ln===38&&p.On&&(t.oa(p),
j(p.lo)))return void i.showHUD('"runKey" should not call itself')
;typeof o=="string"&&(o=o?l.parseEmbeddedOptions(o):null);let y=t.M,$=y&&s.parseFallbackOptions(y),g=y&&y.$f
;if(o&&typeof o=="object"||$||g){let e=f.Rn(p);p=c?Object.assign({},p):p;let l=n.W();o&&s.copyCmdOptions(l,n.Vn(o)),
$&&s.copyCmdOptions(l,n.Vn($)),
e&&s.copyCmdOptions(l,e),l.$f=g,o&&"$count"in o?l.$count=o.$count:e&&"$count"in e&&(o&&"count"in o||(l.$count=e.$count)),
p.lo=l,f.oo(p,f.eo[p.Ln===38&&p.On?"runKey":p.ra])}n.Bl(),d&&p.Ln===38&&p.On?setTimeout(()=>{t.ki=u,
s.executeCommand(p,r,t.Ce,t.$,0,a)},0):(t.ki=u,s.executeCommand(p,r,t.Ce,t.$,0,a))};t.oa=(e,r)=>{var i,o,u,a
;let v=f.Rn(e);if(v||(v=e.lo=n.W()),v.$normalized===2)return;let c=v,b=!0;y(c),c.$normalized=2;let k=1
;for(c.$count&&(k=c.$count,c=v=s.copyCmdOptions(n.W(),c));c&&y(c).length===0&&c.keys.length>=1;){let y=c.keys,m=y[0]
;if(b=b&&y.length===1,typeof m=="string"){let e=c.mask;if(e!=null){c!==v&&(c=v=s.concatOptions(c,v||n.W()))
...
;let A=l.parseKeyNode(j),z=A.key,_=t.qn.get(z)||h(z);if(_!=null&&_.Ln===38&&_.On){if(r||(r=[e]),
r.includes(_))return e.Ln=41,e.ra="showHUD",void(e.lo=n.Vn({text:'"runKey" should not call itself'}));r.push(_),
t.oa(_,r.slice(0))}let w=_?_.ra:z in f.eo?z:null;if(!w)return;let x=_!=null&&_.Ln===38&&_.On
;if(!x&&!b)return void(e.ra=w)
;c!==v&&(v=s.concatOptions(c,v)),v=v.options?s.copyCmdOptions(n.W(),v.options):v.$masked?null:p(v)
...
v=!v||v!==m.options&&v!==A.options?v:s.copyCmdOptions(n.W(),v),
v&&("count"in v||O!=null)&&(O=O!=null?parseFloat(O)||1:parseFloat(v.count||1)||1,delete v.count),
k*=(O!==null&&O!==void 0?O:1)*A.count;let T=_&&f.Rn(_);if(!x)return v=s.concatOptions(T,v),
v&&v===T&&(v=s.copyCmdOptions(n.W(),v)),k!==1&&((v||(v=n.W())).$count=k),void Object.assign(e,f.ii(w,v))
;c=!v||v.keys===void 0&&v.expect===void 0&&v.mask===void 0?T||n.W():v=s.concatOptions(T,v)}}});