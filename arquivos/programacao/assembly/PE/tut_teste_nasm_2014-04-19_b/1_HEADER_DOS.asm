...
; ORG 0x00400000 ; Não tenho certeza disso. Veja "ImageBase"
...
;e_lfanew:                   dd 0x000000C0   ; 0x003C offset ( posição ) no arquivo do cabeçalho WIN (exe).
...
times 4*0x10 db 0x00  ; NÃO SEI POR QUE HAVIA DADOS NESTE ESPAÇO
